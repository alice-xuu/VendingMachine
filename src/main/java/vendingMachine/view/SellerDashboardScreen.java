...
public class SellerDashboardScreen extends Screen {
    ...
    public SellerDashboardScreen(Controller controller){
        super(controller);

        this.removeNode(cancel_btn);

        logout_btn = new Button("logout");
        MoneyDashboard_btn = new Button("Modify Item");
        report1_btn = new Button("Report: Available Items");
        report2_btn = new Button("Report: Summary of Items Sold");
        message = new Label("");
